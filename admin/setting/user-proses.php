...
if (isset($_POST["simpan"])) {
    ...
    if ($_POST["OldPassword"] == $result["PASSWORD"]) {
        ...
        if ($db->execute($arry)) {
            header("location:../admin/setting/index.php?msg=Berhasil update password");
        } else {
            header("location:../admin/setting/index.php?msg=Gagal update profil");
        }
    } else {
        header("location:../admin/setting/index.php?msg=Password lama anda salah");
    }
}
